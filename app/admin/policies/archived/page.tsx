  ...
  return (
    <Layout className="flex flex-col">
      ...
      <ListPageHeader
        ...
        subtitle="These are old versions of your existing policies. Once a new version is added, the previous version is automatically moved to the archive for reference."
        action={
          <Button
            iconRight={<Icon name="delete" className="font-light!" />}
                  ...
                  actions={[
                    ...
                    },
                    {
                      ...
                      icon: (
                        <Icon
                          name="refresh"
                          className="text-[var(--auditly-orange)] text-sm! transform -scale-x-100"
                        />
                      ),
                    },
                    {
